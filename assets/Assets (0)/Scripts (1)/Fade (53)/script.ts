namespace Fade {
  ...
  export function start(direction: Direction, options?: { duration?: number; delay?: number; }, callback?: Function) {
    ...
    if (options.duration == null) options.duration = 1500;
    ...
    if (fadeSpriteRndr != null) {
      ...
      fadeSpriteRndr = new Sup.SpriteRenderer(new Sup.Actor("Black Screen", Sup.getActor("Camera")), "Assets/Sprites/black background fader");
